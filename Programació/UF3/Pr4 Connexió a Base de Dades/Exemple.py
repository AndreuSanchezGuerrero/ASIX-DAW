...
institutDB = mysql.connector.connect(
    ...
    user="perepi",
    password="pastanaga",
    database="Programacióinstitut"
)

cursor = institutDB.cursor()
#Creem la taula alumnes
commandataula = "CREATE TABLE IF NOT EXISTS alumnes (id INT AUTO_INCREMENT PRIMARY KEY, nom VARCHAR(50), cognom1 VARCHAR(50), cognom2 VARCHAR(50), dataNaixement DATE)"
